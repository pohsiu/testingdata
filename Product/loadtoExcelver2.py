...
cursor.execute("SELECT Asin,URL From product_category where isout='1'")
row = cursor.fetchall()
...
for rows in row:
  ...
  if protect_timeout > 20:
    ...
    if avail is not None:
      ...
      if avail2 is None:
        print "Not Available"
        sheet.write(index,10,"Not Available")
      else:
